...
const UTILITY_ASSET_ROOT = "/_utilities/cooking";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/cooking/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/cooking/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("cooking");
