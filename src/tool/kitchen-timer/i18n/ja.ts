...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: 'この<strong>マルチタイマー</strong>ツールは、複数の料理を同時に進行・調整する必要があるホームシェフやプロのために設計されています。',
    },
    {
      type: 'title',
      text: '温度と時間の関係性',
    ...
    {
      type: 'paragraph',
      html: '調理とは本質的に、食品の化学構造を変化させるために一定時間熱を加えることです。タンパク質の変性やメイラード反応はタイマーに大きく依存します。',
    },
    {
      type: 'table',
