...
const faq = [
  ...
  {
    question: '건조 온도가 건조 시간에 영향을 미치는 이유는 무엇인가요?',
    answer: '온도가 높을수록 식품 표면에서 수분 증발 속도가 빨라집니다. 하지만 온도가 너무 높으면 표면 경화(case hardening) 현상이 발생하여 외부는 너무 일찍 마르고 내부 수분이 갇힐 수 있습니다.'
  },
  {
    question: '식품이 완전히 건조되었는지 어떻게 확인하나요?',
    answer: '올바르게 건조된 식품은 끈적이지 않고 마른 느낌이어야 합니다. 과일은 가죽처럼 유연해야 하고, 채소는 잘 부러지거나 바삭해야 하며, 육포용 고기는 부러지지 않고 구부러질 정도로 질겨야 합니다.'
  }
];
...
const howTo = [
  {
    ...
    text: '소고기 육포, 수박 칩, 사과 링, 망고 슬라이스, 버섯과 같은 프리셋 중에서 선택하면 초기 수분 및 기준 건조 시간이 자동으로 설정됩니다.'
  },
  {
    name: '초기 수분 함량 및 목표 수분 함량 조절',
    text: '슬라이더를 사용하여 식품의 시작 수분 및 원하는 목표 수분 함량을 설정합니다.'
  },
  {
    name: '초기 무게 및 건조 온도 설정',
    text: '식품의 생 무게와 식품 건조기의 작동 온도를 입력합니다.'
  },
  {
    name: '예상 건조 시간 및 최종 무게 확인',
    text: '목표 무게, 증발된 수분량, 예상 소요 시간이 표시된 계산 결과를 확인합니다.'
  }
];
