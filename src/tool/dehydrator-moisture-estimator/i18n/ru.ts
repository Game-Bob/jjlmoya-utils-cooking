...
const faq = [
  ...
  {
    question: 'Почему температура дегидратации влияет на время сушки?',
    answer: 'Более высокие температуры ускоряют испарение воды с поверхности продуктов. Однако слишком высокая температура может вызвать закаливание (case hardening), когда внешний слой высыхает слишком быстро и запечатывает влагу внутри.'
  },
  {
    question: 'Как узнать, что продукты полностью дегидратированы?',
    answer: 'Правильно сушеные продукты должны быть сухими на ощупь и не липкими. Фрукты должны быть гибкими и кожистыми, овощи - ломкими или хрустящими, а мясо для джерки - жестким и гнущимся без ломания.'
  }
];
...
const howTo = [
  {
    ...
    text: 'Выберите из наших пресетов, таких как Вяленая говядина, Арбузные чипсы, Яблочные кольца, Дольки манго или Грибы, что автоматически установит начальную влажность и базовое время сушки.'
  },
  {
    name: 'Настройте начальное и целевое содержание влаги',
    text: 'Установите начальную влажность продукта и желаемый целевой уровень влажности с помощью ползунков.'
  },
  {
    name: 'Задайте начальный вес и температуру сушки',
    text: 'Введите сырой вес продукта и рабочую температуру вашего дегидратора.'
  },
  {
    name: 'Просмотрите расчетное время сушки и конечный вес',
    text: 'Ознакомьтесь с рассчитанным результатом, показывающим целевой вес продукта, испаренную воду и примерное количество необходимых часов.'
  }
];
