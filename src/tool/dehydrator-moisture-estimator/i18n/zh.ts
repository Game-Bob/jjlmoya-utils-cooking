...
const faq = [
  ...
  {
    question: '为什么烘干温度会影响干燥时间？',
    answer: '较高的温度能加快水份从食物表面的蒸发速度。但是，温度过高会导致硬壳化（case hardening），即外层干得太快从而将水分锁在内部。'
  },
  {
    question: '如何判断食物是否已完全烘干？',
    answer: '脱水适当的食物触感应干燥且不粘手。水果应干爽柔韧呈皮革状，蔬菜应干脆易碎，肉干应坚韧可弯曲且不易折断。'
  }
];
...
const howTo = [
  {
    name: '选择食材预设或手动设置水分',
    text: '从牛肉干、西瓜脆、苹果圈、芒果片或蘑菇等预设中进行选择，系统会自动设定初始水分和基础干燥时间。'
  },
  {
    name: '调整初始水分和目标水分含量',
    text: '使用滑块设定食物的起始水分以及您期望达到的目标水分含量。'
  },
  {
    name: '设置初始重量和烘干温度',
    text: '输入食物的生重以及食物烘干机的运行温度。'
  },
  {
    name: '查看预计烘干时间和最终重量',
    text: '查看计算输出结果，其中展示了食物目标重量、蒸发水分及预计所需小时数。'
  }
];
