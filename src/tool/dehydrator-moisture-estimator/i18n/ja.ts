...
const faq = [
  ...
  {
    question: 'なぜ乾燥温度が乾燥時間に影響を与えるのですか？',
    answer: '温度が高いほど食品表面からの水分蒸発速度が速くなります。ただし、温度が高すぎるとケースハードニング（表面硬化）が発生し、外側が早く乾きすぎて内側に水分が閉じ込められる可能性があります。'
  },
  {
    question: '食品が完全に乾燥したかどうかを判断するにはどうすればよいですか？',
    answer: '適切に乾燥された食品は、手で触れてもベタつかず乾燥している必要があります。果物はしなやかで革のような質感、野菜は脆くサクサクとした質感、ジャーキー用の肉は硬く折れずに曲がる程度が目安です。'
  }
];

const howTo = [
  {
    name: '食材プリセットまたはカスタム水分量を選択',
    text: 'ビーフジャーキー、スイカスナック、リンゴリング、マンゴースライス、キノコなどのプリセットから選択すると、初期水分量と基本乾燥時間が自動設定されます。'
  },
  {
    name: '初期水分量と目標水分量を調整',
    text: 'スライダーを使用して、食品の開始水分量と希望の目標水分量を設定します。'
  },
  {
    name: '初期重量と乾燥温度を設定',
    text: '食品の生重量とディハイドレーターの動作温度を入力します。'
  },
  {
    name: '推定乾燥時間と最終重量を確認',
    text: '目標重量、蒸発する水分量、および必要な推定時間が表示された計算結果を確認します。'
  }
];
