...
export const content: ToolLocaleContent = {
  ...
  ui: {
    ...
    fruitLabel: 'Wybierz owoc',
    fruit_apple: 'Jabłko',
    fruit_quince: 'Pigwa',
    fruit_blackberry: 'Jeżyna',
    fruit_cranberry: 'Żurawina',
    fruit_gooseberry: 'Agrest',
    fruit_plum: 'Śliwka',
    fruit_apricot: 'Morela',
    fruit_blueberry: 'Borówka',
    fruit_raspberry: 'Malina',
    fruit_peach: 'Brzoskwinia',
    fruit_strawberry: 'Truskawka',
    fruit_pear: 'Gruszka',
    fruit_fig: 'Figa',
    fruit_cherry: 'Wiśnia',
    fruit_grape: 'Winogrono',
    fruit_mango: 'Mango',
    allFruits: 'Wszystkie',
