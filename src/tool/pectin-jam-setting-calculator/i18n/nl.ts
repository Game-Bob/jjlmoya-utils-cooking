...
export const content: ToolLocaleContent = {
  ...
  ui: {
    ...
    fruitLabel: 'Kies je fruit',
    fruit_apple: 'Appel',
    fruit_quince: 'Kweepeer',
    fruit_blackberry: 'Braam',
    fruit_cranberry: 'Veenbes',
    fruit_gooseberry: 'Kruisbes',
    fruit_plum: 'Pruim',
    fruit_apricot: 'Abrikoos',
    fruit_blueberry: 'Bosbes',
    fruit_raspberry: 'Framboos',
    fruit_peach: 'Perzik',
    fruit_strawberry: 'Aardbei',
    fruit_pear: 'Peer',
    fruit_fig: 'Vijg',
    fruit_cherry: 'Kers',
    fruit_grape: 'Druif',
