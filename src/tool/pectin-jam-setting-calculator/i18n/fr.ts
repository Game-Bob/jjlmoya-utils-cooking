...
export const content: ToolLocaleContent = {
  ...
  ui: {
    ...
    fruit_apple: 'Pomme',
    fruit_quince: 'Coing',
    fruit_blackberry: 'Mûre',
    fruit_cranberry: 'Canneberge',
    fruit_gooseberry: 'Groseille',
    fruit_plum: 'Prune',
    fruit_apricot: 'Abricot',
    fruit_blueberry: 'Myrtille',
    fruit_raspberry: 'Framboise',
    fruit_peach: 'Pêche',
    fruit_strawberry: 'Fraise',
    fruit_pear: 'Poire',
    fruit_fig: 'Figue',
    fruit_cherry: 'Cerise',
    fruit_grape: 'Raisin',
