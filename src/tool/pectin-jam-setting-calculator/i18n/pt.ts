...
export const content: ToolLocaleContent = {
  ...
  ui: {
    ...
    fruitLabel: 'Escolha a sua fruta',
    fruit_apple: 'Maçã',
    fruit_quince: 'Marmelo',
    fruit_blackberry: 'Amora',
    fruit_cranberry: 'Arando',
    fruit_gooseberry: 'Groselha',
    fruit_plum: 'Ameixa',
    fruit_apricot: 'Damasco',
    fruit_blueberry: 'Mirtilo',
    fruit_raspberry: 'Framboesa',
    fruit_peach: 'Pêssego',
    fruit_strawberry: 'Morango',
    fruit_pear: 'Pera',
    fruit_fig: 'Figo',
    fruit_cherry: 'Cereja',
    fruit_grape: 'Uva',
