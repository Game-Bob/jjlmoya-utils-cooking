...
export const content: ToolLocaleContent = {
  ...
  ui: {
    ...
    fruitLabel: 'Välj din frukt',
    fruit_apple: 'Äpple',
    fruit_quince: 'Kvitten',
    fruit_blackberry: 'Björnbär',
    fruit_cranberry: 'Tranbär',
    fruit_gooseberry: 'Krusbär',
    fruit_plum: 'Plommon',
    fruit_apricot: 'Aprikos',
    fruit_blueberry: 'Blåbär',
    fruit_raspberry: 'Hallon',
    fruit_peach: 'Persika',
    fruit_strawberry: 'Jordgubb',
    fruit_pear: 'Päron',
    fruit_fig: 'Fikon',
    fruit_cherry: 'Körsbär',
    fruit_grape: 'Druva',
    fruit_mango: 'Mango',
    allFruits: 'Alla',
