...
export const content: ToolLocaleContent = {
  ...
  ui: {
    ...
    fruitLabel: 'Wähle deine Frucht',
    fruit_apple: 'Apfel',
    fruit_quince: 'Quitte',
    fruit_blackberry: 'Brombeere',
    fruit_cranberry: 'Preiselbeere',
    fruit_gooseberry: 'Stachelbeere',
    fruit_plum: 'Pflaume',
    fruit_apricot: 'Aprikose',
    fruit_blueberry: 'Blaubeere',
    fruit_raspberry: 'Himbeere',
    fruit_peach: 'Pfirsich',
    fruit_strawberry: 'Erdbeere',
    fruit_pear: 'Birne',
    fruit_fig: 'Feige',
    fruit_cherry: 'Kirsche',
    fruit_grape: 'Traube',
    fruit_mango: 'Mango',
    allFruits: 'Alle',
