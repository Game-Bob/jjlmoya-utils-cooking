...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: 'Во время сухого вызревания записывайте дату начала, массу и температуру. Регулярно проверяйте свободную циркуляцию воздуха и сравнивайте итоговую массу с расчётом. Срезайте корку только после внимательной оценки запаха, цвета и поверхности мяса.',
    },
  ],
  bibliography,
