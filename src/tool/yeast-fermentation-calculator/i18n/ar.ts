...
export const content: ToolLocaleContent<FermentationUI> = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: "دوّن درجة الحرارة والوقت والكمية حتى تتمكن من مقارنة كل تجربة." },
    { type: 'paragraph', html: "تساعدك الحاسبة على تنظيم التجربة، لكنها لا تلغي المراقبة العملية. سجّل درجة الحرارة وكمية الخميرة وحجم الدفعة، ثم قارن الرائحة والبنية والارتفاع بالنتيجة المتوقعة. إذا تغيّرت الظروف، أعد الحساب واستخدم النطاق الزمني كمرجع عملي لا كموعد ثابت." },
  ],
