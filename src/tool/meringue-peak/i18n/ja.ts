...
export const content: ToolLocaleContent = {
  ...
  howTo, seo: [
    ...
    },
    {
      type: 'diagnostic',
      variant: 'warning',
      title: 'メレンゲから水分（シロップ）が離水していませんか？',
      html: '離水現象（シネレシス）が発生している場合、砂糖が溶け切っていないか湿度が高すぎることが原因です。イタリアンメレンゲではシロップをゆっくり一定の細さで注いでください。',
    },
    {
      type: 'title',
      text: '製菓技術用語集',
    ...
    {
      type: 'paragraph',
      html: '当社の計算機が面倒な計算を自動化するため、完璧なツノが立つまで泡立てに集中できます。',
    },
  ],
  bibliography,
